...
```mermaid
graph TD;
ts-npmrc-private("ts-npmrc-private") --> ts-service-non-esm("ts-service-non-esm")
ts-npmrc-private("ts-npmrc-private") --> ts-tool-non-esm("ts-tool-non-esm")
...
ts-npmrc-private("ts-npmrc-private") --> ts-lib-service-non-esm("ts-lib-service-non-esm")
...
ts-non-esm("ts-non-esm") --> ts-back-non-esm("ts-back-non-esm")
...
dotnet-base("dotnet-base") --> dotnet-tool("dotnet-tool")
...
ts-back("ts-back") --> ts-back-non-esm("ts-back-non-esm")
...
ts-back-non-esm("ts-back-non-esm") --> ts-service-non-esm("ts-service-non-esm")
ts-back-non-esm("ts-back-non-esm") --> ts-tool-non-esm("ts-tool-non-esm")
ts-back-non-esm("ts-back-non-esm") --> ts-lib-service-non-esm("ts-lib-service-non-esm")
```